...
public class BUC9442Steps {
	...
	public void submitPOST(String user, String projectID, String resource, String itemDate) throws Exception {
		...
		utilsSteps.createPOSTRequestBodyObject(getPayloadItem(itemDate));
	...
	public static Item getPayloadItem(String effectiveDate) {
		...
		version.setId(BUC7503testData.getResourceId());
		version.setName(BUC7503testData.getResourceName());
		version.setBaseEntityId("base_BillingAccountOffering");
		version.setValidFor(validFor);
		
		List<Version> versions =  new ArrayList<>();
		versions.add(version);
		
		productOffering.setId(BUC7503testData.getResourceId());
